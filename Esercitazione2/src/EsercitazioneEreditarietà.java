public class EsercitazioneEreditarietà 
{
    public static void main(String[] args) 
    {
        ...
        System.out.println("Costo p1: " + p1.calcolaCosto() + "\n"); // 20.0 (2 * 10.0)
        System.out.println("Costo p3: " + p3.calcolaCosto() + "\n"); // 5.0 (1 * 5.0)

        // Test della classe ProdottoAlimentare
        System.out.println("\n---=== TEST CLASSE PRODOTTO ALIMENTARE ===---");
        ProdottoAlimentare pa1 = new ProdottoAlimentare(true, "Italia", 3, 8.0f, "Olio", "C789");
        ProdottoAlimentare pa2 = new ProdottoAlimentare(pa1);
        ProdottoAlimentare pa3 = new ProdottoAlimentare(false, "Spagna", 2, 12.0f, "Vino", "D012");

        System.out.println("pa1: " + pa1.toString() + "\n");
        System.out.println("pa2: " + pa2.toString() + "\n");
        System.out.println("pa3: " + pa3.toString() + "\n");

        System.out.println("pa1.equals(pa2): " + pa1.equals(pa2) + "\n"); // true (stessi valori)
        System.out.println("pa1.equals(pa3): " + pa1.equals(pa3) + "\n"); // false (valori diversi)
        System.out.println("pa1.equals(p1): " + pa1.equals(p1) + "\n");  // false (classi diverse)

        System.out.println("Costo pa1 (scontato): " + pa1.calcolaCosto() + "\n"); // 12.0 (3 * 8.0 / 2)
