...
public class EsempioAbstract {
    ...
    public static void main(String[] args) {
      ...
      System.out.println(contaFigure(figure)); 
    }
   
    public static String contaFigure(Figura... figure) {
      int numSfere = 0;
      int numQuadrati = 0;
   
      for (Figura f : figure) {
          if (f instanceof Sfera) {
              numSfere++;
      ...
      return "Numero di Sfere: " + numSfere + ", Numero di Quadrati: " + numQuadrati;
   }
}
