...
package Basics;
/*
package rappresenta la cartella in cui è contenuto il file.java (path)

per utilizzare una classe contenuta in un altro package è necessario fare l'import del package
o della classe nello specifico

import java.lang.Math.PI; -> con questo tipo di notazione non sarà più necessario specificare la
Math.PI ma si potrà usare semplicemente PI
lo stesso vale per import java.util.Scanner;
*/
